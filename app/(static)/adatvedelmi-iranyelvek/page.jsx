  ...
  return (
    <div className="container space-y-10 my-5">
      ...
      <div className="space-y-6">
        ...
        <p>COLOMBIA TOURS 97 S.A.S</p>
        <p>Székhely: Calle 59#12B-26, Riohacha, La Guajira, Colombia</p>
        <p>Turisztikai reg. Szám: RNT 100408</p>
        <p>Cégjegyzékszám: NIT 901496984-9</p>
        <p>
          Nyilvántartásba bejegyző hatóság: Camara de Comercio de La Guajira, Colombia - a
          továbbiakban: Adatkezelő.
        </p>
        <p>
          Kérjük, figyelmesen olvassa el jelen adatkezelési tájékoztatónkat (a továbbiakban:
          Tájékoztató), melyben személyes adatai kezelését érintő gyakorlatunkat ismertetjük az
          Általános Adatvédelmi Rendelet (a GDPR, azaz az Európai Parlament és Tanács 2016/679.
          rendelete) szerint. Ez a Tájékoztató az Adatkezelő szolgáltatásait fogyasztóként igénybe
          vevő személyekre (Ön) vonatkozik. Bemutatja, hogy az Adatkezelő hogyan gyűjti, használja
          fel és osztja meg bizonyos esetekben harmadik felekkel az Ön személyes adatait, továbbá
        ...
        <p>
          ...
          magánéletének védelme iránt. Jelen tájékoztató és nyilatkozat mindenekelőtt az ügyfelek és
        ...
        <p>
          A tájékoztató fontos információt nyújt Önnek személyes adatai védelméről és ehhez fűződő
          jogairól. Ha a felhasználó nem fogadja el ezen feltételeket, jogában áll a honlap
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-6">
            <p>
              Jelen Tájékoztatóban ismertetett adatkezelések tekintetében COLOMBIA TOURS 97 S.A.S az
              adatkezelő (a továbbiakban: Adatkezelő).
            </p>
            <p>
              Adatvédelmi eljárásainkat érintő észrevétel, kérdés vagy panasz esetén az alábbi
              elérhetőségeken vagyunk elérhetőek: Calle 59#12B-26 Riohacha, La Guajira, Colombia
              vagy írjon a colombiatours97@hotmail.com e-mail címre.
            </p>
            <p>
              ...
              elfogadása, hírlevél-feliratkozás esetén pedig az adatvédelmi tájékoztató és
              nyilatkozat jóváhagyása. Személyes adat az összes információ, amely közvetett vagy
            ...
            <p>
              ...
              beazonosítható, például: vezetéknév, utónév, állampolgárság, telefonszám, postacím,
              e-mail cím. Az Ön személyes adatait önkéntesen megadott módon, a tulajdonos az oldalon
              ...
              honlap egyes funkcióihoz, szolgáltatásaihoz. Az opcionálisan megadandó adatok gyűjtése
              a felhasználói igények megismerését, a honlap és szolgáltatások fejlesztését
              szolgálja.
            </p>
            <p>
        ...
        <div>
          <h3>Az alábbi személyes adatok kezelése történik:</h3>
          <div className="space-y-6">
        ...
        <div>
          <h3>Adattovábbítás feltételei</h3>
          <div className="space-y-6">
            <p>
        ...
        <div className="space-y-2">
          <h3>Adatfeldolgozást végző vagy adatkezelést érintő cégek, személyek</h3>
          <p>
            A tulajdonos, Szilárd Bélafi ( C.E.1229690 számú kolumbiai személyazonosító okmány )
            végzi az adatok kezelését. A tulajdonoson kívül más cégek is részt vesznek a szerződéses
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-6">
            <li>Könyvelő: Eduardo Sierra, Calle 3#5-25, 440001 Riohacha, La Guajira, Colombia</li>
            <li>
              Tárhely szolgáltató: Sybell Informatika Kft. , Székhely: 1158 Budapest, Késmárk u. 7/B
              2. em. 206.
            </li>
            <li>
              ...
              dokumentum kezelés, továbbá a hozzátartozó szolgáltatások: Google Drive, Google Docs,
              Google Search Console, Google Analytics, Google AdSense, Google AdWords, YouTube,
            ...
            <li>
              Speciális esetekben a szerződés tartalmazhat további adatfeldolgozó személyeket vagy
              cégeket.
            </li>
          </ul>
        </div>
        <div className="space-y-2">
          ...
          <p>
            ...
            szükséges megküldenie az Adatkezelő részére, e-mailben vagy postai levél formájában, a
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-6">
            <p>
              COLOMBIA TOURS 97 S.A.S internetes weboldala, valamint megjelenéseinek tartalma
              ...
              nélkül. Szülei vagy gondviselői kérhetik a gyermekre vonatkozó adatok kiadását,
              törlését. Ha az Adatkezelő számára az adatkezelés, adatfeldolgozás folyamán válik
              nyilvánvalóvá az életkor, abban az esetben a szülői hozzájárulás beszerzése céljából
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-6">
            ...
            <li>
              Adattovábbítás: az Adatkezelő által kezelt személyes adatok harmadik személyek számára
              történő hozzáférhetővé tétele
            </li>
            <li>
              Adatvédelmi incidens: a biztonság sérülése, amely a továbbított, tárolt vagy más módon
            ...
            <li>
              ...
              azonosító, fizikai, fiziológiai, genetikai, szellemi, gazdasági, kulturális vagy
              szociális azonosságára vonatkozó egy vagy több tényező alapján azonosítható
            </li>
            <li>
              Címzett: természetes vagy jogi személy, közhatalmi szerv, ügynökség vagy bármely egyéb
              szerv, amellyel a személyes adatot közlik, függetlenül attól, hogy harmadik fél-e
            </li>
            <li>
            ...
            <li>
              Harmadik fél: természetes vagy jogi személy, közhatalmi szerv, ügynökség vagy bármely
            ...
            <li>
              Hatóság: Nemzeti Adatvédelmi és Információszabadság Hatóság (székhely: 1125 Budapest,
              Szilágyi Erzsébet fasor 22/c., telefon: 06-1 391-1400, fax: 06-1 391-1410, e-mail:
            ...
            <li>
              Weboldal: az Adatkezelő által üzemeltetett, www.colombiatours97.com és az ott
